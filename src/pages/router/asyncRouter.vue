    ...
    <div class="row base-card-shadow" style="margin: 8px;background-color: white">
      <div class="col-md-4 col-sm-4 col-xs-12" style="border-right: 1px solid rgba(0,0,0,0.12)">
        <div
          ...
          style="font-size: 1.32rem;margin: 15px;"
        >
        ...
        <div style="margin: 0 0 0 20px">
          <q-scroll-area
            ref="scrollArea"
            style="height: calc(95vh - 124px);"
            :thumb-style="thumbStyleOfMenu"
          >
            <q-tree
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div
          class="flex justify-between align-center items-center"
          style="font-size: 1.32rem;margin: 15px;height: 36px"
        >
            ...
            >
              <template v-slot:default-header="prop">
                ...
                <div
                  ...
                  style="width: 100%"
                  @click.prevent="handleSelect(prop.node)"
                >
                  <q-icon :name="prop.node.meta.icon || 'share'" class="q-mr-sm" />
                  <div>{{ prop.node.meta.title }}</div>
                </div>
      ...
      <div class="col" style="border-left: 1px solid rgba(0,0,0,0.12)">
        ...
        <div style="margin: 15px">
          <q-input v-model="rolesRouterData" outlined type="textarea" style="height: 100%" />
        </div>
      </div>
    </div>
  </base-content>
...
import { asyncRoutesChildren } from 'src/router/asyncRoutes'
...
} from 'src/router/permissionUtils'
...
export default {
  ...
  watch: {
    rolesSelect (n, o) {
      ...
      this.rolesRouter.baseR = handleBaseRouterToRolesRouter(
        deepClone(this.baseRouter.baseR),
        n
      )
      // 显示 RolesRouter 的数据
