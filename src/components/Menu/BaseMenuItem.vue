  ...
  <div>
    <template v-for="(item,index) in myRouter">
      <template v-if="item.meta.isHidden !== true">
        ...
        <!-- 没有孩子 :style="isWeChart?' line-height: normal':''"   :style="state?'padding-left: 0px;':''"         :inset-level="initLevel"-->
        <q-item
          ...
          :style="initLevel>0?'padding-left: '+bgColorLevel*16+'px;':''"
