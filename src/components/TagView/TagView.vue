<template>
  <!-- <div
    class="row text-grey-8 shadow-box shadow-1"
    style="box-shadow: rgba(0, 0, 0, 0.1) 0px 2px 12px 0px; padding-bottom: 0px"
    :style="{margin:(!$q.screen.gt.sm?'':'5px 0px 0px 0px')}"
  >-->
  <div class="row text-grey-8" :style="{margin:(!$q.screen.gt.sm?'':'0px 0px 0px 0px')}">
    <q-tabs
      align="left"
      active-color="teal-5"
